...
map.getView().fit([8575182.330019, 936100.742327, 8586666.064530, 942165.285725], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">My New Web Map for Neyyatinkara</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (120 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This web map gives you a detailed geographical datas for Neyyatinkara Municipality. It is a open source source program. ';
            }
